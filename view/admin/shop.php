<div class="main-body">
	...
	<div class="card">
		<div class="card-body">
			<div class="row">
				<h5 class="col-8 col-lg-8 col-xl-8">Gian hàng</h5>
				...
				<thead class="thead-light">
					<tr>
						...
						<th scope="col" class="text-right">
							<a data-toggle="tooltip" title="" data-original-title="Bấm vào để xem chi tiết tồn kho của từng mặt hàng">
								Kho<i style="font-size:10px; display: inline;" class="fa fa-question-circle"></i>
							</a>
						</th>
