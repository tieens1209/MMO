...
<!--					</li>-->
	...
	<script src="./view/assets/js/photoswipe.min.js"></script>
	<script src="./view/assets/js/photoswipe-ui-default.min.js"></script>
	<script src="./view/assets/js/select2.min.js"></script>
	<script src="./view/assets/js/number.js"></script>
	<script src="./view/assets/js/main.js"></script>
	<script src="./view/assets/js/header.js"></script>
	<script src="./view/assets/js/svg4everybody.min.js"></script>
	<script src="./view/assets/js/jquery.dataTables.min.js"></script>
	<script src="./view/assets/js/sweetalert.min.js"></script>
	<script src="./view/assets/js/toastr.min.js"></script>
	...
	<script>
		...
		<!-- Google tag (gtag.js) -->
		<script async="" src="./assets/images/js"></script>
		<script>
