...
<head>
	...
	<link rel="stylesheet" href="./view/assets/css/photoswipe.css">
	<link rel="stylesheet" href="./view/assets/css/default-skin.css">
	<link rel="stylesheet" href="./view/assets/css/select2.min.css">
	<link rel="stylesheet" href="./view/assets/css/style.css">
	<!-- font - fontawesome -->
	<link rel="stylesheet" href="./view/assets/css/all.min.css">
	<!-- font - stroyka -->
	<link rel="stylesheet" href="./view/assets/css/stroyka.css">
	<link rel="stylesheet" href="./view/assets/css/jquery.dataTables.min.css">
	<link rel="stylesheet" href="./view/assets/css/sweetalert.css">
	<link rel="stylesheet" href="./view/assets/css/toastr.min.css">
	<link rel="stylesheet" href="./view/assets/css/default.min.css">
	<script src="./view/assets/js/sceditor.min.js"></script>

	<link href="./view/assets/css/datepicker.css" rel="stylesheet" type="text/css">
	<script src="./view/assets/js/jquery-3.5.1.js"></script>
