				...
				<div class="row">
					<div class="col-3">
						<div class="form-group">
							<input placeholder="Nhập mã đơn hàng" value="" class="form-control" id="orderId" name="search_ordernumber" type="text" fdprocessedid="hj5syq">
						</div>
					</div>
					<div class="col-3">
						<div class="form-group">
							<input placeholder="Nhập tên người mua" value="" class="form-control" id="orderId" name="search_username" type="text" fdprocessedid="pjxo9q">
						</div>
					</div>
					<div class="col-6">
						<div class="row">
							<div class="col-6">
								<select name="search_status" id="order_search_option" class="form-control" fdprocessedid="jwidp">
							...
							<div class="col-6">
								<button class="btn btn-success" type="submit" fdprocessedid="gph4v">Tìm đơn hàng</button>
							</div>
						</div>
					</div>
				</div>
