				...
				<div class="row">
					<div class="col-3">
						<div class="form-group">
							<input placeholder="Nhập mã đơn hàng" value="" class="form-control" id="orderId" name="search_ordernumber" type="text" fdprocessedid="nm8yvl">
						</div>
					</div>
					<div class="col-3">
						<div class="form-group">
							<input placeholder="Nhập tên người mua" value="" class="form-control" id="orderId" name="search_username" type="text" fdprocessedid="4ld3g">
						</div>
					</div>
					<div class="col-6">
						<div class="row">
							<div class="col-6">
								<select name="search_status" id="order_search_option" class="form-control" fdprocessedid="3veu4h">
							...
							<div class="col-6">
								<button class="btn btn-success" type="submit" fdprocessedid="ykf2jf">Tìm đơn hàng</button>
							</div>
						</div>
					</div>
				</div>
