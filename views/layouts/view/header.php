...
<head>
	...
	<!-- fonts -->
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/css">
	<!-- css -->
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/bootstrap.min.css">
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/owl.carousel.min.css">
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/photoswipe.css">
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/default-skin.css">
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/select2.min.css">
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/style.css">
	<!-- font - fontawesome -->
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/all.min.css">
	<!-- font - stroyka -->
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/stroyka.css">
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/jquery.dataTables.min.css">
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/sweetalert.css">
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/toastr.min.css">
	<link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/default.min.css">
	<script src="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/js/sceditor.min.js"></script>

	<link href="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/css/datepicker.css" rel="stylesheet" type="text/css">
	<script src="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/js/jquery-3.5.1.js"></script>
	<script src="<?php $_SERVER['DOCUMENT_ROOT']?>/MMO (1)/public/js/moment.min.js"></script>
											...
											<ul class="menu__list">
												<li class="menu__item">
													...
													<a class="menu__item-link" href="https://taphoammo.net/login.html?lang=en">
														<div class="menu__item-icon"><img src="./view/assets/images/en.png" alt=""></div>
														English
													</a>
												</li>
												<li class="menu__item">
													...
													<a class="menu__item-link" href="https://taphoammo.net/login.html?lang=vi">
														<div class="menu__item-icon"><img src="./view/assets/images/vn.png" alt=""></div>
														Tiếng Việt
													</a>
												</li>
											</ul>
													...
													<div style="margin-top: 0px;" class="form-group account-menu__form-button">
														<div style="width: 100%; padding-left: 40px;" class="row">
															<div style="padding: 1px; border: 1px solid #4285f4; text-align: center;" class="col-2">
																<img width="15px" style="margin-top:5px; margin-right:8px" alt="Google sign-in" src="./view/assets/images/gg.png" >
															</div>
